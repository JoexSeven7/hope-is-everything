  ...
  const programs = [
    {
      ...
      description: 'Comprehensive educational support from early childhood through adult learning, focusing on literacy, numeracy, and life skills.',
      features: [
    ...
    },
    {
      ...
      description: 'Building sustainable communities through infrastructure development, healthcare access, and social programs.',
      features: [
    ...
    },
    {
      ...
      description: 'Vocational training and entrepreneurship programs that equip individuals with marketable skills for economic independence.',
      features: [
    ...
    },
    {
      ...
      description: 'Specialized programs designed to empower young people with education, skills, and leadership opportunities.',
      features: [
      ...
      <section className="bg-gradient-to-r from-hope-blue to-blue-700 text-white section-padding">
        <div className="container-max text-center">
          ...
          <p className="text-xl md:text-2xl max-w-3xl mx-auto">
            Comprehensive solutions addressing the root causes of poverty through education, 
        ...
        <div className="container-max">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Each program is designed with a holistic approach, addressing multiple 
              aspects of poverty and creating sustainable change.
            </p>
          </div>
            ...
            {programs.map((program, index) => (
              <div key={program.id} className="bg-white rounded-xl shadow-lg overflow-hidden">
                <div className="grid lg:grid-cols-2 gap-0">
                  ...
                  <div className={`bg-gradient-to-br from-hope-blue to-blue-700 p-8 lg:p-12 flex items-center justify-center ${index % 2 === 0 ? 'lg:order-2' : 'lg:order-1'}`}>
                    <div className="text-center text-white">
                      <div className="text-8xl mb-6">{program.image}</div>
        ...
        <div className="container-max">
          <div className="text-center mb-12">
            ...
            <p className="text-xl text-gray-600">
              See how our programs are transforming lives and communities.
            </p>
          </div>
        ...
        <div className="container-max text-center">
          <div className="max-w-3xl mx-auto">
            ...
            <p className="text-xl mb-8 text-green-100">
              Every program creates ripples of change. Your support helps us reach more 
              communities and transform more lives.
            </p>
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <Link to="/donate" className="bg-white text-hope-green hover:bg-gray-100 font-semibold py-3 px-6 rounded-lg transition-colors">
                Make a Donation
              </Link>
              <Link to="/contact" className="border-2 border-white text-white hover:bg-white hover:text-hope-green font-semibold py-3 px-6 rounded-lg transition-all">
                Get Involved
              </Link>
            </div>
          </div>
